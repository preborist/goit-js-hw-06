...
const getUserWithEmail = (array, mailtoFind) => array.find(({email})=> email === mailtoFind);

console.table(getUserWithEmail(users, 'rossvazquez@xinware.com'));
...
console.table(getUserWithEmail(users, 'blackburndotson@furnigeer.com'));
