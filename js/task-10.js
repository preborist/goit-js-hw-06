...
// const getSortedUniqueSkills = (array) => [...array].reduce((acc, user) => [...acc, ...user.skills], []).reduce((uniqe, item) => uniqe.includes(item) ? uniqe: [...uniqe, item],[]).sort();
const getSortedUniqueSkills = (array) => [...array].reduce((acc, user) => [...acc, ...user.skills], []).filter((value, index, array) => array.indexOf(value) === index).sort();
